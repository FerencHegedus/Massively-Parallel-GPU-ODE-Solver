...
nvprof --profile-api-trace none ./MultiGPUSingleNode.exe 2>>$LogFileName
...
nvprof --kernels :::1 --analysis-metrics -o $ProfFileName -f ./MultiGPUSingleNode.exe 2>>$LogFileName
