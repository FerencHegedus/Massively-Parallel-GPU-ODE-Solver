...
nvprof --profile-api-trace none ./QuasiperiodicForcing.exe 2>>$LogFileName
...
nvprof --kernels :::1 --analysis-metrics -o $ProfFileName -f ./QuasiperiodicForcing.exe 2>>$LogFileName
