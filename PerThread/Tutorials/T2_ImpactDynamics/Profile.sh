...
nvprof --profile-api-trace none ./ImpactDynamics.exe 2>>$LogFileName
...
nvprof --kernels :::1 --analysis-metrics -o $ProfFileName -f ./ImpactDynamics.exe 2>>$LogFileName
