...
nvprof --profile-api-trace none ./DoubleBuffering.exe 2>>$LogFileName
...
nvprof --kernels :::1 --analysis-metrics -o $ProfFileName -f ./DoubleBuffering.exe 2>>$LogFileName
