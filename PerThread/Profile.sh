...
nvprof --profile-api-trace none ./Reference.exe 2>>$LogFileName
...
nvprof --kernels :::1 --analysis-metrics -o $ProfFileName -f ./Reference.exe 2>>$LogFileName
